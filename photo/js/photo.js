(function(){
    var Main = {
        ...
        init: function(){
            ...
            var _this = this;
            var pic = document.getElementById("pic");
			//pic.src = decodeURIComponent(_this.getUrlPara().img);
            pic.onload = function(){
               _this.img = AlloyImage(this); 
               _this.initView();
            };
        ...
        showModel: function(){
            ...
            var effectModel = '<li class="e_item"><div class="imgWrapper"><img src="images/{pic}.png" alt="" />{effect}</div></li>';
            var html = '<li class="e_item"><div class="imgWrapper"><img src="images/e1.jpg" alt="" />原图</div></li>';
